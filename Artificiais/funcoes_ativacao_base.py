...
# def é usado para impl
# # Transfer Functioementar função (Realizam tarafas executadas várias vezes através desses blocos de código);
...
# Possivelmente devido a erro de calculo
